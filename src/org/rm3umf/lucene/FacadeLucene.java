...
public class FacadeLucene {
	 ...
	 * @throws IOException 
	 **/
	public void addDocument(User user,Set<Long> listFollower,Set<Long> listFollowed, String pseudodocument, List<News> pseudodocument_news, List<News> pseudodocument_news_title, List<News> pseudodocument_news_training  ) {
		...
		try {
			this.indexer.index(String.valueOf(user.getIduser()),listFollower,listFollowed,pseudodocument, pseudodocument_news, pseudodocument_news_title, pseudodocument_news_training);
		} catch (IOException e) {
...
//	}
	...
	public Map<Long, Double> retriveByPseudodocument_FolloweeFollower(String pseudodocument){
		Map<Long, Double> listUser=null;

		if(searcher!=null){

			try{
			   	listUser=this.searcher.searchPseudoDocument_FolloweeFollower(pseudodocument);
			}catch (Exception e) {
					logger.info("errore durante la quersy a lucine");
					e.printStackTrace();
			}
	...
	public Map<Long, Double> retriveByNews(String pseudodocument){
		Map<Long, Double> listUser=null;

		if(searcher!=null){

			try{
			   	listUser=this.searcher.searchNews(pseudodocument);
			}catch (Exception e) {
					logger.info("errore durante la quersy a lucine");
					e.printStackTrace();
			}
	...
	//Variante per S7
	public String getPseudodocument_Followee_Follower(long userid) throws ParseException, IOException  {
		String	output = searcher.getFollowee_Follower(userid);			
		return output;
	}
	
	public String getNews(long userid) throws ParseException, IOException  {
		String	output = searcher.getNews(userid);			
		return output;
	}
	
	public String getPseudodocumentTraining(long userid) throws ParseException, IOException  {
		String	output = searcher.getPseudodocumentTraining(userid);			
		return output;
	}
	 ...
	 * followed/followers 
	 */
	public Map<Long, Double> retriveByFollowerFollowed(String pseudodocument){
		Map<Long, Double> listUser=null;
	...
	public Map<Long, Double> retriveByPseudodocumentTraining(String pseudodocument){
		Map<Long, Double> listUser=null;

		if(searcher!=null){

			try{
			   	listUser=this.searcher.searchPseudoDocumentTraining(pseudodocument);
			}catch (Exception e) {
					logger.info("errore durante la quersy a lucine");
					e.printStackTrace();
			}
