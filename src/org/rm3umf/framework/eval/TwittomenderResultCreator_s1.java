 ...
 *
 */
public class TwittomenderResultCreator_s1 extends TwittomenderResultCreator{
...
//				System.out.println("    "+id);
	...
	public String getPseudoDocument(User user) throws ParseException, ParseException, org.apache.lucene.queryParser.ParseException, java.text.ParseException{
		...
		try {
			pseudodocument=FacadeLucene_S1.getInstance().getPseudodocument(user.getIduser());
