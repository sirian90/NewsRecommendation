...
//	private StrategyExtraction estractrionStrategy;
	...
	private StrategyExtraction type;
  ...
  //  	this.estractrionStrategy=FactoryStrategyExtraction.getInstance().getStrategyExtraction();
	...
	public PseudoFragment(User user,Period period,List<Message> tweets, StrategyExtraction enrichment){
		this.user=user;
		this.period=period;
...
//	}
	...
	public StrategyExtraction getType() {
		return type;
	}

	public void setType(StrategyExtraction type) {
		this.type = type;
	}
